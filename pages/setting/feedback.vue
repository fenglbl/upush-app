<template>
  <view class="theme-page theme-panel" :class="themeClass"><view class="setting-shell"><app-navbar :title="tr('setting.feedbackPageTitle')" :theme="theme"></app-navbar><view class="toolbar"><view class="toolbar-subtitle">{{ tr('setting.feedbackPageDesc') }}</view></view><view class="placeholder-card theme-card"><uv-empty mode="message" :text="tr('setting.feedbackPageTitle')"></uv-empty><view class="placeholder-desc">{{ tr('setting.feedbackPageDesc') }}</view></view></view></view>
</template>
<script>

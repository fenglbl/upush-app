...
const messages = {
  zh: {
    ...
    setting: {
      ...
      aboutHeroBadge: '消息触达更简单',
      aboutHeroTitle: '让推送消息的接收、查看与管理更轻松',
      aboutHeroDesc: 'UPUSH 聚焦于设备消息触达体验，把账号、消息和设备管理整合到一个更清晰的移动端入口里。',
      aboutVersionLabel: '当前版本',
      aboutHighlightsTitle: '核心能力',
      aboutHighlightMessagesTitle: '实时消息查看',
      aboutHighlightMessagesDesc: '集中查看设备收到的推送消息，减少信息分散。',
      aboutHighlightAccountTitle: '账号与安全设置',
      aboutHighlightAccountDesc: '支持邮箱验证、安全设置与基础账号管理流程。',
      aboutHighlightExperienceTitle: '轻量清晰的使用体验',
      aboutHighlightExperienceDesc: '提供更简洁的页面结构、主题切换与中英文界面支持。',
      aboutFooterTitle: '持续优化中',
      aboutFooterDesc: '我们会继续打磨 UI、交互体验与消息链路稳定性，让日常使用更顺手。',
      checkUpdate: '检测更新',
  ...
  en: {
    ...
    setting: {
      ...
      aboutHeroBadge: 'Smarter Message Delivery',
      aboutHeroTitle: 'Make push message receiving, viewing and management easier',
      aboutHeroDesc: 'UPUSH focuses on the device message experience, bringing account, messages and device management into one cleaner mobile entry point.',
      aboutVersionLabel: 'Current Version',
      aboutHighlightsTitle: 'Core Capabilities',
      aboutHighlightMessagesTitle: 'Real-time message visibility',
      aboutHighlightMessagesDesc: 'Review incoming push messages in one place and reduce scattered information.',
      aboutHighlightAccountTitle: 'Account and security settings',
      aboutHighlightAccountDesc: 'Support email verification, security actions and essential account management flows.',
      aboutHighlightExperienceTitle: 'Lightweight and clear experience',
      aboutHighlightExperienceDesc: 'Deliver a cleaner page structure, theme switching and bilingual interface support.',
      aboutFooterTitle: 'Still improving',
      aboutFooterDesc: 'We will keep refining the UI, interaction details and message delivery stability to make everyday use smoother.',

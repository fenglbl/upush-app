...
const messages = {
  zh: {
    ...
    setting: {
      ...
      securityEmailCodePlaceholder: '请输入邮箱验证码',
      securitySendCode: '获取验证码',
  ...
  en: {
    ...
    setting: {
      ...
      securityEmailCodePlaceholder: 'Please enter the email verification code',
      securitySendCode: 'Send Code',
